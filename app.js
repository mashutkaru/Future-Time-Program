...
const days = [
  ...
  },
  {
    ...
    city: "Minato, Tokyo",
    theme: "Minato institutions, lunch in Ginza, a TMG visit, and Takanawa Gateway.",
    tip: "Observe how municipal services connect to regional policy and urban spaces.",
    items: [
      ["MINATO CITY HALL", "Institution visit.", ICONS.building],
      ["MINATO SPORTS CENTER", "Sports center visit.", ICONS.sports],
      ["LUNCH", "Sushi Tofuro Ginza — obento.", ICONS.dinner],
      ["TAKANAWA GATEWAY", "Cultural visit.", ICONS.hub],
    ],
    program: [
      ["08:30–10:00", "Minato City Hall", "Institution visit"],
      ["10:00–12:00", "Minato Sports Center", "Institution visit"],
      ["12:15–12:45", "Lunch", "Sushi Tofuro Ginza (obento)"],
      ["14:00–16:00", "Tokyo Metropolitan Government", "Institution visit"],
  ...
  },
  {
    ...
    program: [
      ...
      ["13:20–16:00", "Asoka-en Elderly Living Service Center", "Integrated elderly care facility visit"],
  ...
  },
  {
    ...
    program: [
      ...
      ["14:30–16:30", "Zenkou Research Institute (Care Tech Lab)", "Rehabilitation & innovation visit"],
      [
        "17:45–22:00",
        "Final Event",
