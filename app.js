...
const days = [
  ...
  },
  {
    ...
    items: [
      ["PREVENTIVE CENTER", "Rakuccha — comprehensive care prevention center.", ICONS.medical],
      ["MINATO SPORTS CENTER", "Sports center visit.", ICONS.sports],
      ["LTC DISCUSSION", "Long-term care and prevention systems.", ICONS.panel],
      ["TAKANAWA GATEWAY", "Cultural visit.", ICONS.hub],
    ],
    program: [
      ["09:30–10:00", "Minato — Preventive center", "ラクっちゃ（介護予防総合センター）"],
      ["10:00–10:30", "Minato Sports Center", "Institution visit"],
      ["10:45–11:30", "Minato City — discussion", "LTC and prevention systems"],
